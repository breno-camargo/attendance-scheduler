      ...
      >
        ...
        >
          <h3
            ...
            style={{ marginBottom: '0.25rem', fontSize: '1.35rem', fontWeight: 800 }}
          >
        ...
        <div style={{ padding: '1rem 1.5rem', overflowY: 'auto', flex: 1, minHeight: 0 }}>
        ...
        <div
          style={{
            padding: '1rem 1.5rem',
            borderTop: '1px solid var(--primary-border-subtle)',
